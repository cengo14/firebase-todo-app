          ...
          <>
            <div className="flex items-center justify-between px-3">
              <div className="flex items-center gap-2">
                <img
                  className="size-12 max-md:size-8  rounded-full my-5"
                  src={
                    user.photo
                      ? user.photo
              ...
              <div>
                <div className=" flex gap-2 relative">
                  ...
                  >
                    ...
                    <span className="lable max-md:text-[12px]">Hesap</span>
                  </button>
                  <button
            ...
            <TodoForm />
            <div className="flex w-4/6 max-md:w-11/12 mx-auto justify-center mt-5">
              <ul
                ref={animationParent}
                className="w-full flex flex-col gap-y-2"
              >
                <li className="bg-neutral-900 flex max-md:text-[12px]  items-center justify-center rounded w-full py-2 px-2">
                ...
                {todos?.map((todo) => (
                  <li
                    ...
                    key={todo.id}
                  >
                    <p className=" w-6/12 py-4 px-2 bg-neutral-700 rounded-2xl max-md:text-[12px] max-sm:text-[10px]">
                      {" "}
                      {todo.todo}
                    </p>
                    <p className=" w-3/12 max-md:text-[12px] max-sm:text-[10px] py-4 ps-2 bg-neutral-700 rounded-2xl flex items-center justify-evenly">
                    ...
                    <div className="bg-neutral-700 rounded-2xl w-3/12 py-[6px] max-md:py-[5px]">
                      {todo.uid === user.uid ? (
                        <div className="flex w-full px-2">
                          <button
                            className=" md:me-2 w-1/2 max-md:p-2 bg-blue-600 hover:bg-blue-700 transition flex justify-center items-center"
                            onClick={() => setIsEditingTodo(todo)}
                          >
                            <span>
                              <FaRegEdit className="max-md:text-xl" />
                            </span>
                            <span className="max-md:hidden">Düzenle</span>
                          </button>
                          <button
                            className=" w-1/2 max-md:p-2 bg-red-600 hover:bg-red-700 transition flex justify-center  items-center"
                            onClick={() => handleDelete(todo.id)}
                          >
                            <span>
                              <MdDeleteForever className="max-md:text-xl" />
                            </span>
                        ...
                        <div className="py-[10px] max-md:py-1 flex justify-center items-center gap-2 w-full">
                          <img
